...
const aesEncrypt = (appendedPlaintextBin, key) => {
  ...
  const ciphrtBase64 = "00";
  console.log(cipherTextHexBlocks);
  return {
    numberOfBlocks,
...
const aesEncryptBlock = (plaintextBlockBin, key) => {
  console.log("1", plaintextBlockBin);
