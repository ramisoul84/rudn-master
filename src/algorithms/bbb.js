...
const aesEncrypt = (plainText, key) => {
  ...
  console.log(appendedPlaintextBin);
  const numberOfBlocks = appendedPlaintextBin.length / 16;
  console.log(numberOfBlocks);
  const roundKeysBin = keyExpansion(key).roundKeysBin;
  console.log(roundKeysBin);
  ...
  console.log(cipherTextBinBlocks);
};
//
const aesEncryptBlock = (plaintextBlockBin, key) => {
  ...
  console.log(states[0][5]);
  console.log(subBytes(states[0][5]));
  console.log(shiftRows(subBytes(states[0][5])));
  console.log(mixColumns(shiftRows(subBytes(states[0][5]))), "mix");
...
function dot(a1, b1) {
  ...
  console.log(p.toString(2).slice(-8));
